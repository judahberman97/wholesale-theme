(function() {
  ...
  theme.classes.CoreSearch = (function() {
    ...
    CoreSearch.prototype.load = function() {
      var _this;
      _this = this;
      console.log(  _this.text_box)
      _this.text_box.on('click',()=>{
        _this.text_box.trigger('keyup');
      })
      ...
      document.addEventListener(
        ...
        function(event) {
          ...
          if (
            event.target.matches(".mobile-nav--search") ||
            event.target.matches(".search--root") ||
            !event.target.closest(".search--root")
          ) {
            _this.results.css('display', 'none')
            _this.text_box.val('').trigger('keyup');
          }
        },
        false
      )
    ...
    CoreSearch.prototype.listenForKeyEntered = function() {
      ...
      return _this.text_box.attr("autocomplete", "off").on("keyup paste", function(event) {
        ...
        _this.results.css('display', 'flex')
  ...
  new (Main = (function() {
    ...
    Main.prototype.load = function() {
      ...
      //theme.utils.stylesheetLoaded().then(function() {
        theme.utils.loadJsClasses();
        theme.body.attr('data-assets-loaded', 'true');
      //});
